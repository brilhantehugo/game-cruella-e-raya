...
const BASE = 'Pomeranian dog lulu da pomerania blue merle, small fluffy, pixel art 16-bit SNES style, ' +
             '32x32 pixels, side view facing right, blue merle coat with gray blue and black patches, ' +
