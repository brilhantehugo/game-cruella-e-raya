...
export const LEVEL_1_1: LevelData = {
  ...
  decorations: [
    ...
    { type: 'arvore', x: 980,  y: G },
    { type: 'loja',   x: 1200, y: G },
    { type: 'poste',  x: 1450, y: G },
    { type: 'casa',   x: 1750, y: G },
    { type: 'arvore', x: 2020, y: G },
...
export const LEVEL_1_2: LevelData = {
  ...
  decorations: [
    ...
    { type: 'casa',   x: 1050, y: G },
    { type: 'poste',  x: 1300, y: G },
    { type: 'loja',   x: 1540, y: G },
    { type: 'arvore', x: 1800, y: G },
    { type: 'poste',  x: 2070, y: G },
    { type: 'casa',   x: 2350, y: G },
  ],
}
...
export const LEVEL_1_3: LevelData = {
  ...
  decorations: [
    ...
    { type: 'loja',   x: 340,  y: G },
    { type: 'poste',  x: 580,  y: G },
    { type: 'casa',   x: 800,  y: G },
    { type: 'loja',   x: 1060, y: G },
    { type: 'arvore', x: 1300, y: G },
    { type: 'loja',   x: 1560, y: G },
    { type: 'poste',  x: 1850, y: G },
    { type: 'arvore', x: 2080, y: G },
