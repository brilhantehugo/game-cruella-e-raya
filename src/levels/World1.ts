...
export const LEVEL_1_1: LevelData = {
  ...
  decorations: [
    { type: 'poste',   x: 100,  y: G },
    { type: 'arvore',  x: 280,  y: G },
    { type: 'casa',    x: 520,  y: G },
    { type: 'lixeira', x: 700,  y: G },
    { type: 'poste',   x: 900,  y: G },
    { type: 'arvore',  x: 1100, y: G },
    { type: 'loja',    x: 1350, y: G },
    { type: 'lixeira', x: 1600, y: G },
    { type: 'casa',    x: 1850, y: G },
    { type: 'arvore',  x: 2100, y: G },
    { type: 'poste',   x: 2350, y: G },
  ],
}
