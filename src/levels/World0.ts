...
export const LEVEL_0_1: LevelData = {
  ...
  enemies: [
    ...
    { type: 'gato',  x: 550,  y: 390 },
    { type: 'rato',  x: 800,  y: 390 },
    { type: 'dono',  x: 1050, y: 390 },
    { type: 'gato',  x: 1300, y: 390 },
    { type: 'rato',  x: 1600, y: 390 },
    { type: 'dono',  x: 1850, y: 390 },
  ],
  items: [
  ...
  nextLevel: '0-boss',
  decorations: [
    { type: 'cadeira',  x: 110,  y: G },
    { type: 'mesa',     x: 280,  y: G },
    { type: 'vaso',     x: 490,  y: G },
    { type: 'cadeira',  x: 700,  y: G },
    { type: 'grade',    x: 870,  y: G },
    { type: 'estante',  x: 1060, y: G },
    { type: 'vaso',     x: 1250, y: G },
    { type: 'mesa',     x: 1450, y: G },
    { type: 'cadeira',  x: 1680, y: G },
    { type: 'grade',    x: 1870, y: G },
  ],
}
